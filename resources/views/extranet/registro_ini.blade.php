                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text mt-2">
                            <form action="{{ route('extranet.registro_ini-guardar') }}" method="POST" autocomplete="off">
                                @csrf
                                @method('post')
                                ...
                                <div class="form-group mt-3">
                                    <label class="requerido" for="tipo_documentos_id">Tipo documento</label>
                                    <select class="form-control form-control-sm" name="tipo_documentos_id" id="tipo_documentos_id"
                                        required>
                                        <option value="">--Seleccione un tipo--</option>
