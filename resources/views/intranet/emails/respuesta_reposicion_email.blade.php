...
<body>
    <div class="row">
        <div class="col-12">
            ...
            <br>
            <p>Estimado Usuario. Le informamos que se ha dado respuesta a la reposición de su pqr</p>
        </div>
        <div class="col-12">
            <p>Lo invitamos a ingresar a la plataforma Quiku y consultar la respuesta de sus Solicitudes en el siguiente
                link <a href="{{ route('dashboard') }}" target="_blank" rel="noopener noreferrer">Quiku</a> en la opción
                listado pqrs</p>
        </div>
    </div>
