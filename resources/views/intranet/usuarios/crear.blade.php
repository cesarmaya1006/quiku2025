                    ...
                    <div class="row d-flex">
                            ...
                            @if ($tipo->id == 1 || $tipo->id == 2 || $tipo->id == 3 || $tipo->id == 5 || $tipo->id == 7 || $tipo->id == 8)
                                <div class="col-12 col-md-4">
                                    <div class="card card-Light collapsed-card" style="box-shadow: 0px 0px 0px 0px ;">
                                        <div class="card-header">
                                            <h3 class="card-title col-11 justify-content-center text-white">
                                                @if ($tipo->id < 4)
                                                    <a class="col-12" href="{{ route($tipo->url, ['id' => $tipo->id]) }}">
                                                        @switch($tipo->id)
                                                            @case(1)
                                                                <span class="justify-content-center text-white text-white" style="font-size: 2.5em; color: white;">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </span>
                                                                @break
                                                            @case(2)
                                                                <span class="justify-content-center text-white" style="font-size: 2.5em; color: white;">
                                                            ...
                                                            @default
                                                        @endswitch
                                                        <p class="mt-3 text-white">{{ $tipo->tipo }}</p>
                                                    </a>
                                                @else
                        ...
                        <div class="col-12 col-md-12">
                            <div class="card card-Light collapsed-card" style="box-shadow: 0px 0px 0px 0px ;">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <a href="" style="text-decoration: none;" class="otros-btn text-white">Otros</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card card-Light collapsed-card" style="box-shadow: 0px 0px 0px 0px ;">
                                        <div class="card-header">
                                            <h3 class="card-title col-11">
                                                @if ($tipo->id < 4)
                                                    <a href="{{ route($tipo->url, ['id' => $tipo->id]) }}"><p>{{ $tipo->tipo }}</p></a>
                                                @else
                                                    <a href="{{ route($tipo->url) }}" style="text-decoration: none;">
                                                        @switch($tipo->id)
                                                            @case(4)
