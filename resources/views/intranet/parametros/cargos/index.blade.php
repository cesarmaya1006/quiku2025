        ...
        <div class="card-header">
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('admin-funcionario-cargos-crear') }}"
                    ...
                    <table class="table table-striped table-hover table-sm display">
                        ...
                        <tbody>
                            @foreach ($cargos as $cargo)
                                <tr>
                                    <td class="text-center">{{ $cargo->nivel->area->area }}</td>
                                    <td class="text-center">{{ $cargo->nivel->nivel }}</td>
                                    <td class="text-center">{{ $cargo->cargo }}</td>
                                    <td class="text-center">
                                        <a href="{{ route('admin-funcionario-cargos-editar', ['id' => $cargo->id]) }}"
