        ...
        <div class="card-header">
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-8 text-md-right pr-md-5">
                    ...
                    <a href="{{ route('wiku_area-crear', ['id' => $id, 'wiku' => $wiku]) }}"
                        class="btn btn-success btn-xs text-center pl-1 pr-1 mr-1" style="font-size: 0.9em;"><i
                            class="fas fa-plus-circle mr-2"></i> Nueva Área</a>

                    <a href="{{ route('wiku_volver_area', ['id' => $id, 'wiku' => $wiku]) }}"
                            ...
                            @foreach ($areas as $area)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('wiku_area-editar', ['id_area' => $area->id, 'id' => $id, 'wiku' => $wiku]) }}"
