        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-lg-left pl-2">
                    <h5>Editar Temas Especificos</h5>
                </div>
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('wiku_temaespecifico-index', ['id' => $id, 'wiku' => $wiku]) }}"
            ...
            <div class="row">
                <div class="col-12">
                    <form
                        action="{{ route('wiku_temaespecifico-actualizar', ['id_especifico' => $temaespecif->id, 'id' => $id, 'wiku' => $wiku]) }}"
                        class="form-horizontal row" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            @include('intranet.parametros.wiku.areas_temas.temasespecificos.form')
                        </div>
                        <!-- /.card-body -->
...
@section('script_pagina')
    <script src="{{ asset('js/intranet/parametros/temaespecifico.js') }}"></script>
@endsection
<!-- ************************************************************* -->
