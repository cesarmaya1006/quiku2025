        ...
        <div class="card-header">
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('wiku_doccriterios-crear', ['id' => $doctrina->id, 'wiku' => $wiku]) }}"
                        ...
                        <tbody>
                            @foreach ($criterios as $criterio)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('wiku_doccriterios-editar', ['id_criterios' => $criterio->id, 'id' => $doctrina->id, 'wiku' => $wiku]) }}"
                                            class="btn-accion-tabla tooltipsC" title="Editar este registro">
                                            <i class="fas fa-pen-square"></i>
                                        </a>
                                        <form action="{{ route('wiku_doccriterios-eliminar', ['id' => $criterio->id]) }}"
