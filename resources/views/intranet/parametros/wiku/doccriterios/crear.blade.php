        ...
        <div class="card-header">
            <div class="row mb-3">
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-lg-left pl-2">
                    <h5>Nueva Criterio</h5>
                </div>
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('wiku_doccriterios-index', ['id' => $id, 'wiku' => 'doctrina']) }}"
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('wiku_doccriterios-guardar', ['id' => $id, 'wiku' => $wiku]) }}"
                        class="form-horizontal row" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            @include('intranet.parametros.wiku.doccriterios.form')
                        </div>
                        <!-- /.card-body -->
