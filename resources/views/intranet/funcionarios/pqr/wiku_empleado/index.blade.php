...
<!-- Pagina CSS -->
@section('css_pagina')
    <link rel="stylesheet" href="{{ asset('css/intranet/pqr/wiku_empleado.css') }}">
@endsection
<!-- ************************************************************* -->
@section('tituloPagina')
Solicitud de edición y/o anexar elementos a la Wiku
<a href="{{route('funcionario-gestionar-asignacion-colaboracion',['id' => $id])}}" class="btn btn-info btn-sombra btn-xs float-end"><i class="fas fa-undo mr-3" aria-hidden="true"></i>Regresar</a>
@endsection
<!-- ************************************************************* -->
                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-three-argumento" role="tabpanel"
                            ...
                            <div class="row d-flex justify-content-around">
                                ...
                                <div class="col-12 col-md-3 text-md-right pl-2 pr-md-5">
                                    <a href="{{ route('wiku_argcriterios_empleado-crear',['id' => $id]) }}"
                                        class="btn btn-success btn-sm text-center pl-3 pr-3 float-right"
                                        style="font-size: 0.8em;"><i class="fas fa-plus-circle mr-2"></i> Crear
                                        Argumento</a>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($argumentos as $argumento)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        <a href="{{ route('wiku_argcriterios_empleado-editar', ['id' => $id,'id_arg' => $argumento->id]) }}"
                                ...
                                <div class="col-12 col-md-3 text-md-right pl-2 pr-md-5">
                                    <a href="{{ route('wiku_norma-crear') }}"
                                        ...
                                        style="font-size: 0.8em;{{ $fuentes->count() == 0 ? 'opacity: 0.4; cursor: default;pointer-events: none;' : '' }}"><i
                                            class="fas fa-plus-circle mr-2"></i> Crear Norma</a>
                                </div>
                            </div>
                            <div class="row mt-3" style="font-size: 0.8em;">
                                <div class="col-12">
                            ...
                            <div class="row d-flex justify-content-around">
                                ...
                                <div class="col-12 col-md-3 text-md-right pl-2 pr-md-5">
                                    <a href="{{ route('wiku_jurisprudencia-crear') }}"
                                        class="btn btn-success btn-sm text-center pl-3 pr-3"
                                        style="font-size: 0.8em;{{ $fuentes->count() == 0 ? 'opacity: 0.4; cursor: default;pointer-events: none;' : '' }}"><i
                                            class="fas fa-plus-circle mr-2"></i> Crear Jurisprudencia</a>
                                </div>
                            </div>
                            <div class="row mt-3" style="font-size: 0.8em;">
                                <div class="col-12">
                            ...
                            <div class="row d-flex justify-content-around">
                                ...
                                <div class="col-12 col-md-3 text-md-right pl-2 pr-md-5">
                                    <a href="{{ route('wiku_doctrina-crear') }}"
                                        class="btn btn-success btn-sm text-center pl-3 pr-3"
                                        style="font-size: 0.8em;{{ $fuentes->count() == 0 ? 'opacity: 0.4; cursor: default;pointer-events: none;' : '' }}"><i
                                            class="fas fa-plus-circle mr-2"></i> Crear Doctrina</a>
                                </div>
                            </div>
                            <div class="row mt-3" style="font-size: 0.8em;">
                                <div class="col-12">
...
@section('script_pagina')
    <script src="{{ asset('js/intranet/pqr/wiku_empleado.js') }}"></script>
