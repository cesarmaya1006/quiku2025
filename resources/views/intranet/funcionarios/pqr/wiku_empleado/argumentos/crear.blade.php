        ...
        <div class="card-header">
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-6 text-md-right text-lg-right pl-2 pr-md-5 pr-lg-5">
                    <a href="{{ route('gest_wiku_empleado',['id' => $id]) }}" class="btn btn-success btn-xs btn-sm text-center pl-3 pr-3"
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('wiku_argcriterios_empleado-guardar',['id' => $id]) }}" class="form-horizontal row" method="POST"
                        autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            @include('intranet.funcionarios.pqr.wiku_empleado.argumentos.form')
                        </div>
                        <!-- /.card-body -->
