...
@section('cuerpoPagina')
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('wiku_argcriterios_empleado-actualizar', ['id' => $id,'id_arg' => $argumento->id]) }}"
                        ...
                        <div class="card-body">
                            ...
                            @include('intranet.funcionarios.pqr.wiku_empleado.argumentos.formeditar')
                        </div>
                        <!-- /.card-body -->
