...
class CrearTablaAccionanteAccionado extends Migration
{
    ...
    public function up()
    {
        Schema::create('accionante_accionado', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('tipo_documentos_id_accion');
            $table->foreign('tipo_documentos_id_accion', 'fk_persona_accion')->references('id')->on('tipo_documentos')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->unsignedBigInteger('tipo_documentos_id_apoderado')->nullable();
            $table->foreign('tipo_documentos_id_apoderado', 'fk_persona_apoderado')->references('id')->on('tipo_documentos')->onDelete('restrict')->onUpdate('restrict');
