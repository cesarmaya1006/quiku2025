...
class WikuAsociacionJur extends Model
{
    use HasFactory, Notifiable;
    protected $table = 'wikujurisasociaciones';
    protected $guarded = [];
    //----------------------------------------------------------------------------------
    ...
    {
        return $this->belongsToMany(WikuJurisprudencia::class, 'wiku_jurisprudencia_id', 'id');
    }
}
